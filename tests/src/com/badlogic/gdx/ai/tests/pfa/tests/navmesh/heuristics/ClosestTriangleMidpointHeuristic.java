...
/** @author jsjolund */
public class ClosestTriangleMidpointHeuristic extends NavMeshHeuristic {
	...
	/** Estimates the distance between two Triangles, by calculating the distance between their closest edge midpoints.
	 *
	 * @param node
	 * @param endNode
	 * @return */
